...
namespace PaperTrails
{
    ...
    {
        public static readonly string[] Names={"Cube","Sphere","Star","Heart","Cat","Dog","Husky","Duck","Shark","Penguin","Frog","Dinosaur","Bee","Sports Car","Tank","UFO","Rocket","Robot","Astronaut","Dragon","Ghost","Slime","Burger","Pizza","Donut","Banana","Traffic Cone","Rubber Duck","Eyeball","Knife","Bronze Block","Silver Block","Gold Block","Galaxy Cube","Jinxie"};
        ...
        static readonly System.Collections.Generic.Dictionary<int,float> PremiumYaw=new System.Collections.Generic.Dictionary<int,float>{{4,0f},{6,0f},{13,-90f},{14,-90f},{17,0f},{29,180f}};
